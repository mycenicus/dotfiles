" Based on wildcharm colorscheme

hi clear
let g:colors_name = 'highcontrast'
...
if &background == 'dark'
  ...
  hi NonText guifg=#585858 guibg=NONE guisp=NONE gui=NONE ctermfg=12 ctermbg=NONE cterm=NONE term=bold
  ...
  hi CursorLineNr guifg=Yellow guibg=NONE guisp=NONE gui=bold ctermfg=11 ctermbg=NONE cterm=bold term=bold
  " ctermfg=231 is also ok
  hi LineNr guifg=Yellow guibg=NONE guisp=NONE gui=NONE ctermfg=11 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi VertSplit guifg=#767676 guibg=#767676 guisp=NONE gui=NONE ctermfg=235 ctermbg=243 cterm=NONE term=NONE
  hi Search guifg=NONE guibg=#5f431f guisp=NONE gui=NONE ctermfg=214 ctermbg=16 cterm=reverse term=bold,reverse,underline
  hi IncSearch guifg=NONE guibg=#3a4a3a guisp=NONE gui=NONE ctermfg=11 ctermbg=16 cterm=reverse term=reverse
  hi Visual guifg=LightGrey guibg=#575757 guisp=NONE gui=NONE ctermfg=0 ctermbg=248 cterm=NONE term=NONE
  ...
  hi Error guifg=White guibg=Red guisp=NONE gui=reverse ctermfg=15 ctermbg=9 cterm=reverse term=bold,reverse
  hi ErrorMsg guifg=White guibg=Red guisp=NONE gui=reverse ctermfg=15 ctermbg=1 cterm=NONE term=bold,standout
  hi FoldColumn guifg=#585858 guibg=NONE guisp=NONE gui=NONE ctermfg=240 ctermbg=NONE cterm=NONE term=NONE
  hi Folded guifg=#767676 guibg=#303030 guisp=NONE gui=NONE ctermfg=246 ctermbg=236 cterm=NONE term=NONE
